...
export default function ListingsPage() {
  ...
  const filteredListings = useMemo(() => {
    ...
    return listings.filter((listing) => {
      if (locationFilter && listing.project.location !== locationFilter) return false;
      if (minBedrooms && listing.bedrooms < minBedrooms) return false;
      if (minArea && Number.isFinite(minAreaValue) && minAreaValue > 0 && Number(listing.sizeSqm) < minAreaValue) {
        return false;
      }
        ...
        <section className="lp-container lp-listings-layout">
          <aside className="lp-listings-sidebar">
            ...
            <div className="lp-listings-area">
              ...
              />
              <input type="text" placeholder="SQM" aria-label="Area unit" disabled />
            </div>
          </aside>
                    ...
                    <article key={listing.id} className="lp-property-card">
                      ...
                      <div className="lp-property-body">
                        <p className="lp-property-price lp-property-price-red">
                          {usdPrice || formatUsd(listing.priceKes) || 'Price on request'}
                        </p>
                        <h3>
                        ...
                        <div className="lp-listing-stats">
                          ...
                          <div>
                            <strong>{Number(listing.sizeSqm).toLocaleString()}</strong>
                            <span>SQM</span>
                          </div>
                        </div>
                      </div>
