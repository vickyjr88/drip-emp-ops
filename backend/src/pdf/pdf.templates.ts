...
export function invoicePdfTemplate(params: {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>${BASE_STYLES}</style></head><body>
    ...
    <div class="footer-note">Generated by Drip Emporium. This document is auto-generated and does not require a signature.</div>
  </body></html>`;
}
...
export function salesContractPdfTemplate(params: {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>${BASE_STYLES}</style></head><body>
    ...
    <div class="footer-note">Generated by Drip Emporium. This is a system-generated summary of the sale agreement and payment schedule and is not a substitute for the fully executed legal contract.</div>
  </body></html>`;
}
