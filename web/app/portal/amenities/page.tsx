...
export default function AmenitiesPage() {
  ...
  const categoryFiltered = categoryFilter
    ...
    : amenities;
  const controls = useListControls(categoryFiltered, (amenity) => [
    amenity.name,
    amenity.category,
    amenity.description,
  ]);
  const visibleAmenities = controls.visible;
      ...
      <main className="lp-main-content portal-main is-authenticated">
        <section className="lp-container portal-auth-section">
          ...
          >
            ...
            <article className="portal-card" data-tour="amenities.catalog">
              ...
              <div className="list-toolbar">
                <ListSearch controls={controls} placeholder="Search amenities…" />
                  <ListExport
              ...
              <ListPager controls={controls} noun="amenities" />
            </article>
          </PortalShell>
        </section>
      </main>
