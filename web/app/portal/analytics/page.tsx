 ...
 * rather than rendering a dashboard under a "Analytics" heading.
 */
        ...
        <section className="lp-container" style={{ paddingTop: 72 }}>
          <article className="portal-card">
            ...
            <p className="portal-muted">
              This list is not built yet for Drip Emporium. The dashboard carries the headline sales figures in the meantime.
            </p>
