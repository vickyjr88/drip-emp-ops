          ...
          >
            ...
            {tab === 'invoices' ? (
              <div className="portal-stack-grid">
                {canCreateInvoice ? (
                  <article className="portal-card" data-tour="receivable.bulk">
                ...
                <article className="portal-card" data-tour="receivable.invoices">
                  <div className="portal-card-header-row">
                    <h2 style={{ margin: 0 }}>Invoices</h2><TourLauncher tour="accounting-basics" />
                    {canCreateInvoice ? (
                    ...
                    <ListExport
                      ...
                      config={{
                        ...
                        columns: [
                          ...
                          { header: 'Customer', value: (row) => customerLabel(customers.find((c) => c.id === row.customerId)) },
                          { header: 'Source', value: (row) => row.sourceType },
            ...
            {tab === 'receipts' ? (
              <div className="portal-stack-grid">
                <article className="portal-card" data-tour="receivable.receipts">
                  <div className="portal-card-header-row">
                    ...
                    <ListExport
                      ...
                      config={{
                        ...
                        columns: [
                          ...
                          { header: 'Status', value: (row) => row.status },
                          { header: 'Received', value: (row) => formatDate(row.receivedAt) },
                        ],
                      }}
                    />
                  </div>
